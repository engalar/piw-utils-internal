...
export declare function hidePropertyIn<T, TKey extends keyof T>(
...
export declare function hideNestedPropertiesIn<T, TKey extends keyof T>(
...
export declare function changePropertyIn<T, TKey extends keyof T>(
    propertyGroups: PropertyGroup[],
    _value: T,
